...
(function() {
    ...
    var z = {},
            ...
            for (var v = 0; l && v < l.length; v++)
                if (d = l[v], "." === d && 0 > k) k = v;
                    ...
                    if ("%" === d) h *= 100;
                        ...
                        k = v + d.length - 1;
                        continue
                    } else "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || (r = !0);
            ...
            for (v = r = l = e = k = 0; 0 < n.length;)
                if (d = n.pop(), "#" === d || "0" === d)
                    if (k++, k === p) {
                        ...
                        for (; 0 < w.length;) b = w.pop() + b, v++, 0 === v % r && (l === q && 0 < w.length) && (b = g + b);
                        c && (b = "-" + b)
                    } else 0 < h.length ? (b = h.pop() + b, e++, v++) : "0" === d && (b = "0" + b, e++, v++),
                        0 === v % r && (l === q && 0 < h.length) && (b = g + b);
            else "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? "," === d ? (l++, r = v, v = 0, 0 < h.length && (b = g + b)) : b = 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? d.slice(1, d.length - 1) + b : d + b : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), b += d.replace(/[0]+/, function(a) {
                return P(s, a.length)
            }));
            c = "";
            for (g = !1; 0 < m.length;) d = m.shift(), "#" === d || "0" === d ? 0 < a.length && 0 !== Number(a.join("")) ? (c += a.shift(), g = !0) : "0" === d && (c +=
        ...
        sa = 1,
        Q = Ma ? za / sa : 1,
        Aa = window && window.location && window.location.href && window.location.href.indexOf && (-1 !== window.location.href.indexOf("canvasjs.com") || -1 !== window.location.href.indexOf("fiddle")),
        Ta = {
            reset: {
                ...
                a: {
                    ...
                    if (f && 0 < f.length || g) {
                        var h, b = [],
                            ...
                            k = null;
                        if (f)
                            for (var n = f[0].split("; "), f = 0; f < n.length; f++) b.push(n[f].split("=")[0]), l.push(n[f].split("=")[1]);
                        g && (k = g);
                        h = {
                            ckVal: Number(l[0]),
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = [], l = [], k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if ("normal" === m.axisPlacement || "xySwapped" ===
                    m.axisPlacement) var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if (c < s && !e) null !== m.dataPoints[p].y && (r = c);
                    else {
                        if (!e && (e = !0, 0 < p)) {
                            p -= 2;
                            continue
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = !1, l = !1, k = [], n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]],
                    ...
                    q = !1,
                    r;
                if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var d =
                ...
                var n = this.data[a.dataSeriesIndexes[k]],
                    ...
                    e = !1,
                    q, r, s;
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var v = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                ...
                var c = f ? this.dragStartPoint.x : this.plotArea.x1,
                    ...
                    n = g ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
    ...
    A.prototype.validateRegion = function(a, d, b, c, f) {
        f = f || !1;
        for (var g = 0 <= this.zoomType.indexOf("x"), h = 0 <= this.zoomType.indexOf("y"), l = !1, k = [], n = [], m = [], p = 0; p < this.axisX.length; p++) this.axisX[p] &&
        ...
        for (p = 0; p < this.axisY2.length; p++) this.axisY2[p] && h && n.push(this.axisY2[p]);
        for (g = 0; g < n.length; g++) {
            ...
            if (isFinite(h.dataInfo.minDiff))
                if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) ||
                        p < h.minimum || e > h.maximum)) k.push(h), m.push({
                    val1: p,
                    val2: e
                }), l = !0;
                else if (!f) {
    ...
    A.prototype.renderIndexLabels = function(a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            var n = this._indexLabels[a],
                ...
                p, e, l = L("indexLabelFontColor", n.dataPoint, n.dataSeries),
                k = L("indexLabelFontSize", n.dataPoint, n.dataSeries);
            p = L("indexLabelFontFamily", n.dataPoint, n.dataSeries);
            e = L("indexLabelFontStyle", n.dataPoint, n.dataSeries);
            var h = L("indexLabelFontWeight", n.dataPoint, n.dataSeries),
                q = L("indexLabelBackgroundColor", n.dataPoint, n.dataSeries),
                f = L("indexLabelMaxWidth", n.dataPoint, n.dataSeries),
                g = L("indexLabelWrap", n.dataPoint, n.dataSeries),
                r = L("indexLabelLineDashType", n.dataPoint, n.dataSeries),
                s = L("indexLabelLineColor",
                    n.dataPoint, n.dataSeries),
                v = x(n.dataPoint.indexLabelLineThickness) ? x(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness,
            ...
            if (n.dataSeries.indexLabelFormatter ||
                n.dataPoint.indexLabelFormatter) y = {
                chart: this,
            ...
            if (null !== t && "" !== t) {
                var w = L("indexLabelPlacement", n.dataPoint, n.dataSeries),
                    y = L("indexLabelOrientation", n.dataPoint, n.dataSeries),
                    D = n.direction,
                    Z = n.dataSeries.axisX,
                    aa = n.dataSeries.axisY,
                    z = !1,
                    q = new W(d, {
                        x: 0,
                        y: 0,
                ...
                if (0 <= m.indexOf("line") || 0 <= m.indexOf("area") || 0 <= m.indexOf("bubble") || 0 <= m.indexOf("scatter")) {
                    if (n.dataPoint.x < Z.viewportMinimum || n.dataPoint.x > Z.viewportMaximum || n.dataPoint.y < aa.viewportMinimum || n.dataPoint.y > aa.viewportMaximum) continue
                } else if (0 <= m.indexOf("column")) {
                    if (n.dataPoint.x < Z.viewportMinimum || n.dataPoint.x > Z.viewportMaximum || n.bounds.y1 > b.y2 || n.bounds.y2 < b.y1) continue
                ...
                } else if (n.dataPoint.x < Z.viewportMinimum || n.dataPoint.x > Z.viewportMaximum) continue;
                f = h = 2;
    ...
    A.prototype.renderLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var e = l._colorSet,
                    q = e = l.lineColor = l.options.lineColor ? l.options.lineColor : e[0];
                d.strokeStyle = e;
                var r = !0,
                    s = 0,
                    v, w;
                ...
                if (0 < k.length) {
                    for (var y = !1, s = 0; s < k.length; s++)
                        if (v = k[s].x.getTime ? k[s].x.getTime() : k[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof k[s].y) 0 < s && !(l.connectNullData || y || r) && (d.stroke(), u && b.stroke()), y = !0;
                            else {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var k = l.dataPoints,
                    n = "solid";
                if (d.setLineDash) {
                    var m = I(l.nullDataLineDashType, l.lineThickness),
                        n = l.lineDashType,
                        p = I(n, l.lineThickness);
                    d.setLineDash(p)
                }
    ...
    A.prototype.renderSpline = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var q = k._colorSet,
                    r = q = k.lineColor = k.options.lineColor ? k.options.lineColor : q[0];
                b.strokeStyle = q;
                var s = 0,
                    v, w, y = [];
                b.beginPath();
                if (0 < n.length)
                    for (w = !1, s = 0; s < n.length; s++)
                        if (v = n[s].getTime ? n[s].x.getTime() : n[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof n[s].y) 0 < s && !w && (k.connectNullData ? b.setLineDash && (0 < y.length && (k.options.nullDataLineDashType || !n[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, m = k.nullDataLineDashType) : (d(y), y = [])), w = !0;
                            else {
                                v = a.axisX.convertValueToPixel(v);
                                ...
                                if (0 < n[s].markerSize || 0 < k.markerSize) {
                                    ...
                                    k.indexLabel || n[s].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: n[s],
                                    dataSeries: k,
                                    point: {
                ...
                if (0 < e.length)
                    for (var q = 5 < m && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            var r = a.axisX.reversed ? g - m << 0 : g + m << 0,
                                s;
                            0 <= e[f].y ? s = k : (s = h, h = k);
                            h > s && (b = h, h = s, s = b);
                    ...
                    for (l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() :
                            ...
                            var c = a.axisX.convertValueToPixel(b),
                                ...
                                w = v + p << 0,
                                y;
                            if (a.axisY.logarithmic) h[b] = r[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (k = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : n, f[b] = k);
                            ...
                            (r[l].indexLabel || q.indexLabel || r[l].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > r[l].y === a.axisY.reversed ? 1 :
                                    -1,
                                bounds: {
                                    x1: v,
                                    y1: Math.min(k, y),
    ...
    A.prototype.renderStackedColumn100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                h = [],
                l = 0,
                k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                if (0 < r.length)
                    for (var s = 5 < p && q.bevelEnabled ? !0 : !1, l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
                            ...
                            u && N(this._eventManager.ghostCtx, v, k, w, y, b, 0, null, !1, !1, !1, !1);
                            (r[l].indexLabel ||
                                q.indexLabel || r[l].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                    ...
                    if (0 < e.length) {
                        ...
                        for (f = 0; f < e.length; f++)
                            if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" ===
                                ...
                                var r = a.axisX.reversed ? h - m << 0 : h + m << 0,
                                    s;
                                0 <= e[f].y ? s = k : (s = g, g = k);
                                b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
    ...
    A.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
                m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
                    ...
                    for (l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() :
                            ...
                            var c = a.axisX.convertValueToPixel(b),
                                ...
                                w = v + p << 0,
                                y;
                            if (a.axisY.logarithmic) h[b] = r[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : n, f[b] = k = a.axisY.convertValueToPixel(h[b]));
                            else if (k = a.axisY.convertValueToPixel(r[l].y), 0 <= r[l].y) {
                                var t = f[b] ? f[b] : 0;
                                y = n + t;
                                k += t;
    ...
    A.prototype.renderStackedBar100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                h = [],
                l = 0,
                k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                    0),
                l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
                    ...
                    for (l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
                            ...
                            if (a.axisY.logarithmic) {
                                ...
                                k += t;
                                f[b] = t + (k - v)
                            } else t = g[b] ? g[b] : 0, v = k - t, k = n - t, g[b] = t + (k - v);
                            b = r[l].color ? r[l].color : q._colorSet[l % q._colorSet.length];
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                var h = [],
                    e = !0,
                    q = 0,
                    r, s, v, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    y, t = null;
                if (0 < p.length) {
                    var D = m._colorSet[q % m._colorSet.length],
                        x = m.lineColor = m.options.lineColor || D,
                        aa = x;
                    b.fillStyle = D;
                    b.strokeStyle = x;
                    ...
                    for (var J = !0; q < p.length; q++)
                        if (v = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !J)))
                            if ("number" !== typeof p[q].y) m.connectNullData ||
                                (J || e) || d(), J = !0;
                            else {
                                r = a.axisX.convertValueToPixel(v);
                                s = a.axisY.convertValueToPixel(p[q].y);
                                e || J ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, s), u && c.lineTo(r, s)) : (b.beginPath(), b.moveTo(r, s), u && (c.beginPath(), c.moveTo(r, s)), t = {
                                    x: r,
                                    y: s
                                }), J = e = !1) : (b.lineTo(r, s), u && c.lineTo(r, s), 0 == q % 250 && d());
                                ...
                                0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < m.markerSize) && (v = m.getMarkerProperties(q, r, s, b), l = v.color, h.push(v), H = G(H), u && h.push({
                                    x: r,
                                    y: s,
                                    ctx: c,
                                    type: v.type,
        ...
        function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    var h = [],
                        e = 0,
                        q, r, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        v, w = null,
                        y = [];
                    if (0 < p.length) {
                        ...
                        for (r = !1; e < p.length; e++)
                            if (q = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof p[e].y) 0 < e && !r && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray =
                                    ...
                                    if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize)) {
                                        var J = m.getMarkerProperties(e, q, r, b),
                                            l = J.color;
                                        h.push(J);
                                        R = G(R);
                                        u && h.push({
    ...
    A.prototype.renderStepArea = function(a) {
        function d() {
            t && (0 < m.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(r, y), b.lineTo(t.x, y), b.closePath(),
                b.globalAlpha = m.fillOpacity, b.fill(), b.globalAlpha = 1, u && (c.lineTo(r, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(r, s), c.beginPath(), c.moveTo(r, s), t = {
                    x: r,
                    y: s
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < p.length) {
                    ...
                    if (b.setLineDash) {
                        var R =
                            I(m.nullDataLineDashType, m.lineThickness),
                            B = m.lineDashType,
                    ...
                    for (; q < p.length; q++)
                        if (v = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !D))) {
                            ...
                            "number" !== typeof p[q].y ? (m.connectNullData || (D || e) || d(), D = !0) : (r = a.axisX.convertValueToPixel(v), s = a.axisY.convertValueToPixel(p[q].y), e || D ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || B === m.lineDashType && m.lineDashType !==
                                m.nullDataLineDashType) && (b.stroke(), B = m.nullDataLineDashType, b.setLineDash(R)), b.lineTo(r, H), b.lineTo(r, s), u && (c.lineTo(r, H), c.lineTo(r, s))) : (b.beginPath(), b.moveTo(r, s), u && (c.beginPath(), c.moveTo(r, s)), t = {
                                x: r,
                                y: s
                            }), D = e = !1) : (b.lineTo(r, H), u && c.lineTo(r, H), b.lineTo(r, s), u && c.lineTo(r, s), 0 == q % 250 && d()), q < p.length - 1 && (A !== (p[q].lineColor || z) || B !== (p[q].lineDashType || m.lineDashType)) && (d(), A = p[q].lineColor || z, b.strokeStyle = A, b.setLineDash && (p[q].lineDashType ? (B = p[q].lineDashType, b.setLineDash(I(B, m.lineThickness))) :
                                (B = m.lineDashType, b.setLineDash(J)))), H = m.dataPointIds[q], this._eventManager.objectMap[H] = {
                                id: H,
                                objectType: "dataPoint",
                                dataSeriesIndex: n,
                                dataPointIndex: q,
    ...
    A.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                m = [],
                p = 0,
                e, q, r, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
            ...
            for (var w = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                var y = a.dataSeriesIndexes[h],
                    ...
                    D = t.dataPoints;
                t.dataPointIndexes = [];
                for (p = 0; p < D.length; p++) y = D[p].x.getTime ? D[p].x.getTime() : D[p].x, t.dataPointIndexes[y] = p, w[y] || (n.push(y), w[y] = !0);
                n.sort(ya)
            }
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var J = !0, p = 0; p < n.length; p++) {
                        r = n[p];
                        var H = null,
                            H = 0 <= t.dataPointIndexes[r] ? D[t.dataPointIndexes[r]] : {
                                x: r,
                                y: null
                            };
                        if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(),
                                ...
                                } else q = a.axisY.convertValueToPixel(H.y), q -= ea;
                                k.push({
                                    x: e,
                                    y: s - ea
                                });
                                ...
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, q), u && v.lineTo(e, q)) : (b.beginPath(), b.moveTo(e, q), u && (v.beginPath(),
                                    v.moveTo(e, q))), J = w = !1) : (b.lineTo(e, q), u && v.lineTo(e, q), 0 == p % 250 && (d(), b.moveTo(e, q), u && v.moveTo(e, q), k.push({
                                    x: e,
                                    y: s - ea
                                })));
                                p < D.length - 1 && (z !== (D[p].lineColor || x) || A !== (D[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, q), k.push({
                                    x: e,
                                    y: s - ea
                                ...
                                0 <= t.dataPointIndexes[r] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (r = t.getMarkerProperties(p, e, q, b), g = r.color, f.push(r), markerColor = G(fa), u && f.push({
                                    x: e,
                                    y: q,
                                    ctx: v,
                                    type: r.type,
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var J = !0, p = 0; p < n.length; p++) {
                        r = n[p];
                        var H = null,
                            H = 0 <= t.dataPointIndexes[r] ? x[t.dataPointIndexes[r]] : {
                                x: r,
                                y: null
                            };
                        if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData ||
                                (J || w) || d(), J = !0;
                            else {
                                var ea;
                                ...
                                if (a.axisY.logarithmic) {
                                    ...
                                    if (0 >= m[r]) continue;
                                    q = a.axisY.convertValueToPixel(m[r])
                                } else q = a.axisY.convertValueToPixel(ea), q -= fa;
                                k.push({
                                    x: e,
                                    y: s - fa
                                });
                                ...
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || B === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(E)),
                                    b.lineTo(e, q), u && v.lineTo(e, q)) : (b.beginPath(), b.moveTo(e, q), u && (v.beginPath(), v.moveTo(e, q))), J = w = !1) : (b.lineTo(e, q), u && v.lineTo(e, q), 0 == p % 250 && (d(), b.moveTo(e, q), u && v.moveTo(e, q), k.push({
                                    x: e,
                                    y: s - fa
                                })));
                                p < x.length - 1 && (A !== (x[p].lineColor || z) || B !== (x[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, q), k.push({
                                    x: e,
                                    y: s - fa
                                ...
                                0 <= t.dataPointIndexes[r] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (r = t.getMarkerProperties(p, e, q, b), h = r.color, g.push(r), markerColor = G(Fa), u && g.push({
                                    x: e,
                                    y: q,
                                    ctx: v,
                                    type: r.type,
                                ...
                                (H.indexLabel || t.indexLabel ||
                                    H.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = -Infinity, l = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                for (var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, e = 0, c = 0; c < p.length; c++) f = p[c].getTime ? f = p[c].x.getTime() : f =
                ...
                if (n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, 0 < p.length)
                    for (d.strokeStyle = "#4572A7 ", c = 0; c < p.length; c++)
                        if (f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[c].y) {
                            ...
                            var e = p[c].z,
                                r = 2 * Math.max(Math.sqrt((h === l ? b / 2 : q + (b - q) / (h - l) * (e - l)) / Math.PI) << 0, 1),
                        ...
                        for (var m = 0, p = 0, c = 0; c < n.length; c++)
                            if (f = n[c].getTime ? f = n[c].x.getTime() : f = n[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[c].y) {
                                ...
                                Math.sqrt((m - f) * (m - f) + (p - g) * (p - g)) < Math.min(e.size,
                                    5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (m = k.dataPointIds[c], this._eventManager.objectMap[m] = {
                                    id: m,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: l,
                                    dataPointIndex: c,
                                    x1: f,
                                    y1: g
                                }, m = G(m), u && O.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, m, m, e.borderThickness), (n[c].indexLabel || k.indexLabel || n[c].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: n[c],
                                    dataSeries: k,
                                    point: {
    ...
    A.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                c = this.plotArea,
                f = 0,
                g, h, l, k, n, m, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth :
                1;
                ...
                if (0 < s.length)
                    for (var v = 5 < p && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? m = s[f].x.getTime() : m = s[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length &&
                            ...
                            var w = g - p / 2 << 0,
                                y = w + p << 0,
                                c = s[f].color ? s[f].color : r._colorSet[0],
                    ...
                    for (var e = 5 < l && m.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)
                        if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                            ...
                            var q = a.axisX.reversed ? b + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount +
                                ...
                                r = a.axisX.reversed ? q - l << 0 : q + l << 0,
    ...
    A.prototype.renderRangeArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    var y =
                        n._colorSet[e % n._colorSet.length],
                    ...
                    for (var E = !0; e < m.length; e++)
                        if (v = m[e].x.getTime ? m[e].x.getTime() : m[e].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !E)))
                            if (null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" ===
                                ...
                                p || E ? (n.connectNullData && !p ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = B, z = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(q, r), u && c.lineTo(q, r), l.push({
                                    x: q,
                                    y: s
                                })) : (b.beginPath(), b.moveTo(q, r), w = {
                                    x: q,
                                    y: r
                                }, l = [], l.push({
                                    x: q,
                                    y: s
                                }), u && (c.beginPath(), c.moveTo(q, r))), E = p = !1) : (b.lineTo(q, r), l.push({
                                    x: q,
                                    y: s
                                }), u && c.lineTo(q, r), 0 == e % 250 && d());
                                v = n.dataPointIds[e];
                        ...
                        if (p = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                            ...
                            if (null !== n[m].y && n[m].y.length && "number" === typeof n[m].y[0] && "number" === typeof n[m].y[1]) {
                                ...
                                if (0 !== n[m].markerSize && (0 < n[m].markerSize || 0 < k.markerSize)) {
                                    var B = k.getMarkerProperties(m, p, e, b),
                                        g = B.color;
                                    f.push(B);
                                    var E = G(A);
                                    u && f.push({
    ...
    A.prototype.renderPie = function(a) {
        function d() {
            if (n && m) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < m.length; f++) {
                    ...
                    if (n.indexLabelFormatter || g.indexLabelFormatter) r = {
                        chart: k.options,
                        dataSeries: n,
                        dataPoint: g,
                        total: p.total,
                ...
                h = g = 0;
                p = !1;
                for (f = 0; f < m.length; f++) l = q[(c + f) % m.length], 1 < a && (l.midAngle > Math.PI / 2 - w && l.midAngle < Math.PI / 2 + w) && (g <= a / 2 && !p ? (l.hemisphere = "right", g++) : (l.hemisphere = "left", p = !0));
                p = !1;
                for (f = 0; f < m.length; f++) l =
        ...
        function b(a) {
            ...
            for (b = 0; b < m.length; b++) {
                ...
                if (d > c) {
                    ...
                    } else if (0 < Math.abs(q[b].center.x - t.x) || 0 < Math.abs(q[b].center.y - t.y)) q[b].center.x = t.x + f * (1 - a), q[b].center.y = t.y + g * (1 - a), l = !0;
        ...
        function f(a) {
            for (var b = null, d = 1; d < m.length; d++)
                if (b = (a + d + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) {
                    ...
                    q[b].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y))) break;
            else b = null;
            return b
        }
            ...
            if (0 <= a && a < m.length) {
                ...
                for (l = 1; l < m.length; l++)
                    if (k = (a - l + q.length) % q.length, q[k].hemisphere !== q[a].hemisphere) {
                        k = null;
                        break
                    } else if (q[k].indexLabelText && q[k].hemisphere === q[a].hemisphere && k !== a && (0 > c(q[k], q[a]) || ("right" === q[a].hemisphere ? q[k].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[k].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y))) break;
                else k = null;
                n = k;
                p = f(a);
                l = k = 0;
        ...
        function h() {
            ...
            for (var b = a = 0, d = 0, l = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                if (n.radius || !n.radius &&
                    "undefined" !== typeof n.innerRadius && null !== n.innerRadius && B - d <= E) l = !1;
                l && (B -= d);
                d = 0;
                if ("inside" !== n.indexLabelPlacement) {
                    ...
                    for (a = 0; a < m.length; a++) h = q[a], s = "pie" === n.type ? 0.7 * B : 0.8 * B, x = t.x + s * Math.cos(h.midAngle), u = t.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = x, h.indexLabelTextBlock.y = u;
                for (a = 0; a < m.length; a++)
                    if (h = q[a], x = h.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width) x = x = 0, "right" === h.hemisphere ? (x = e.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), x *= -1) : x = e.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < x && (!l && h.indexLabelText && (u = "right" === h.hemisphere ? e.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - e.x1, 0.3 * h.indexLabelTextBlock.maxWidth > u ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * u, 0.3 * h.indexLabelTextBlock.maxWidth <
                            ...
                            if (null !== h) {
                                ...
                                if (l = 0 > z) {
                                    ...
                                    var n = w.indexLabelTextBlock.y - w.indexLabelTextBlock.height / 2,
                                        r = w.indexLabelTextBlock.y + w.indexLabelTextBlock.height / 2,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]],
                ...
                u = 0;
            a = !1;
            for (var A = 0; A < m.length; A++) u += Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel && null !== m[A].indexLabel && 0 < m[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[A].label && null !== m[A].label && 0 < m[A].label.toString().length) && (a = !0);
            if (0 !== u) {
        ...
        for (var m =
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? $.getDefaultLegendMarker(p.type) : p.markerType,
                    q = p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                        chart: this.chart,
                        legend: this.options,
                        dataSeries: p,
                        dataPoint: null
                    }) : p.name,
                    r = p.legendMarkerColor =
                    ...
                    q = this.chart.replaceKeywordsWithValue(q, p.dataPoints[0], p, m),
                    e = {
                        markerType: e,
                        markerColor: r,
                        text: q,
                ...
                for (var u = 0; u < p.dataPoints.length; u++) {
                    var t = p.dataPoints[u],
                        ...
                        q = t.legendText ? t.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart,
                            legend: this.options,
                            dataSeries: p,
                            dataPoint: t
                        ...
                        q = this.chart.replaceKeywordsWithValue(q, t, p, u),
                        e = {
                            markerType: e,
                            markerColor: r,
                            text: q,
        ...
        for (m = d = 0; m < n.length; m++) {
            ...
            for (t = u = 0; t < p.items.length; t++) {
                ...
                if ("line" === e.chartType || "stepLine" === e.chartType || "spline" ===
                    e.chartType) this.ctx.strokeStyle = e.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(r - 0.1 * this.lineHeight, v + this.lineHeight / 2), this.ctx.lineTo(r + 0.85 * this.lineHeight, v + this.lineHeight / 2), this.ctx.stroke(), q -= 0.1 * this.lineHeight;
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "doughnut":
                            ...
                            r < e.radius &&
                                r > v && (r = Math.atan2(d - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (e.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), v = Number(((180 * (e.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === v && 1 < e.endAngle && (v = 360), s >= v && 0 !== q.y && (v += 360, r < s && (r += 360)), r > s && r < v && (c.push({
                                    dataPoint: q,
                                    dataPointIndex: g,
                                    dataSeries: this,
                                    distance: 0
    ...
    B.prototype.createLabels = function() {
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)
            if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle %
                ...
                if (g = 0.9 * k >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = 0; b < this._labels.length; b++) {
                        ...
                        for (var r, s = a.text.split(" "), c = 0; c < s.length; c++) e = s[c], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, e = this.ctx.measureText(e), e.width > p && (r = b, p = e.width)
                    }
                    b = 0;
                        ...
                        if (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock, d = d.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
                            ...
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c), s = (m - (n + a.fontSize / 2) *
                                ...
                                if (x(this.options.labelWrap))
                                    ...
                                    if (c = q.width + d.width >> 0, e = this.labelFontSize, p < g) c - 2 * g > l && (l = c - 2 * g, c >= 2 * g && c < 2.2 * g ? (this.sessionVariables.labelMaxWidth =
            ...
            if (g = x(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, h = "undefined" === typeof this.options.labelWrap || this.labelWrap ?
                ...
                this.sessionVariables.labelWrap = this.labelWrap;
                for (b = 0; b < this._labels.length; b++)(a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock,
    ...
    B.setLayoutAndRender = function(a, d, b, c, f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > q;) {
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, l = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, n = Math.round(g.y2 - X - f - C), b[e].lineCoordinates = {
                        ...
                        width: k - h,
                        height: n - l
                    }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), O += u[e] + b[e].margin);
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(h), C = c[e]._labels && 0 < c[e]._labels.length ? c[e]._labels[c[e]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(g.y1 + V + L < Math.max(C,
                        10) ? Math.max(C, 10) : g.y1 + V + L), C = 0 < a.length ? 0 : c[e]._labels[0].textBlock.height / 2, n = Math.round(g.y2 - (X + f + C)), c[e].lineCoordinates = {
                        x1: h + P,
                        y1: l,
                        x2: h + P,
                        y2: n,
                        ...
                        width: k - h,
                        height: n - l
                    }, c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.height ? c[e].titleMaxWidth : c[e].lineCoordinates.height), P += t[e] + c[e].margin);
                if (a && 0 < a.length)
                ...
                if (0 < q) {
                    if (a && 0 < a.length)
                        for (e =
                            0; e < a.length; e++) E = H[q - 1][e] === H[q][e] ? !0 : !1;
                    else E = !0;
                    if (d && 0 < d.length)
                        for (e = 0; e < d.length; e++) F = I[q - 1][e] === I[q][e] ? !0 : !1;
                    else F = !0;
                    if (b && 0 < b.length)
                        for (e = 0; e < b.length; e++) G = M[q - 1][e] === M[q][e] ? !0 : !1;
                    else G = !0;
                    if (c && 0 < c.length)
                        for (e = 0; e < c.length; e++) J = K[q - 1][e] === K[q][e] ? !0 : !1;
                    else J = !0
                }
                if (E && F && G && J) break;
                q++
            ...
            for (; 4 > q;) {
                ...
                I.push(B);
                if (d && 0 < d.length)
                    for (r = [], e = V = 0; e < d.length; e++) r.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), V += r[e], L += d[e] ? d[e].margin : 0;
                else r.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                M.push(r);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) b[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), k = Math.round(g.x2 - V - L > m.width - 10 ? m.width - 10 : g.x2 - V - L), b[e].labelAutoFit && !x(v) && (0 < !a.length && (h = 0 > b[e].labelAngle ? Math.max(h, v) : 0 === b[e].labelAngle ? Math.max(h, v / 2) : h), 0 < !d.length && (k = 0 < b[e].labelAngle ? k - w / 2 : 0 === b[e].labelAngle ?
                ...
                if (b && 0 < b.length)
                    for (z = [], e = P = 0; e < b.length; e++) z.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), P += z[e] + b[e].margin, C += b[e].margin;
                ...
                H.push(A);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) 0 < b[e]._labels.length && (n = b[e]._labels[0], l = b[e]._labels[b[e]._labels.length - 1], v = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) + (n.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(n.textBlock.angle)),
                ...
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--) l = Math.round(g.y2), n = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = l - (z[e] + b[e].margin + N), b[e].lineCoordinates.y2 = l - (z[e] + b[e].margin + N), b[e].bounds = {
                        x1: h,
                ...
                if (c && 0 < c.length)
                    for (e = c.length - 1; 0 <= e; e--) c[e] && (l = Math.round(g.y1), n = Math.round(g.y1 + (A[e] + c[e].margin + Q)), c[e].lineCoordinates.y1 = n, c[e].lineCoordinates.y2 = n, c[e].bounds = {
                        x1: h,
                        y1: l + (c[e].margin + Q),
                        x2: k,
                        y2: n,
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) {
                        ...
                        if (b && 0 < b.length)
                            for (C = 0; C < b.length; C++) b[C] && b[C].labelAutoFit && (k = 0 > b[e].labelAngle ? Math.max(k, v) : 0 === b[e].labelAngle ? Math.max(k, v / 2) : k, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? k - V : h);
                        if (c && 0 < c.length)
                ...
                if (0 < q) {
                    ...
                    if (d && 0 < d.length)
                        for (e = 0; e < d.length; e++) F = M[q - 1][e] === M[q][e] ? !0 : !1;
                    else F = !0;
                    if (b && 0 < b.length)
                        for (e = 0; e < b.length; e++) G = s[q - 1][e] === s[q][e] ? !0 : !1;
                    else G = !0;
                    if (c && 0 < c.length)
                        for (e = 0; e < c.length; e++) J = H[q - 1][e] === H[q][e] ? !0 : !1;
                    else J = !0
                }
                if (E && F && G && J) break;
                q++
    ...
    S.prototype.getToolTipInnerHTML = function(a) {
        ...
        if (h && (this.content && "function" === typeof this.content ||
            ...
            if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" ===
                c.type || "stackedArea100" === c.type) a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (f.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}";
            else if ("bubble" === c.type) a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") +
                ...
                "rangeSplineArea" === c.type) a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (f.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
            else if ("candlestick" === c.type || "ohlc" === c.type) a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ?
        ...
        this.content = a;
        for (l = 0; l < this.chart.data.length; l++) this.chart.data[l].toolTipContent = this.content;
        return b
    };
    ...
    A.prototype.replaceKeywordsWithValue = function(a, d, b, c, f) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            else return "y" === a ? da(h, d.yValueFormatString ? d.yValueFormatString : b.yValueFormatString ?
        ...
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c])
                if (c = this.objectMap[c], "dataPoint" === c.objectType) {
                    ...
                    f.dataPoints[c.dataPointIndex] : null, c.eventParameter = {
                        x: b.x,
                        y: b.y,
                        dataSeries: f.options,
                        dataPoint: g,
    ...
    var F = {
        ...
        Oa = {
            ...
            formatDate: function(a,
                d, b) {
                b = b || "en";
                if (pa[b]) return Ea(a, d || "DD MMM YYYY", new oa(b));
                throw "Unknown Culture Name";
            }
        };
